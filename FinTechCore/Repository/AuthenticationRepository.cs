...
namespace FinTechCore.Repository
{
    public  class AuthenticationRepository:IAuthenticationRepository
    {
        ...
        public async Task<Responses<string>> ChangePassword(ChangePasswordDTO changePasswordDTO)
        {
        ...
        public async Task<Responses<string>> ForgottenPassword(ResetPasswordDTO model)
        {
            ...
            var response = new Responses<string> { Succeeded = false };
            if (user == null)
            {
                response.StatusCode = (int)HttpStatusCode.BadRequest;
            ...
            await _emailService.SendEmailMassageAsync(emailMsg);
            response.Succeeded = true;
        ...
        public async Task<Responses<LoginUserDTO>> Login(LoginDTO model)
        {
            ...
            var response = new Responses<LoginUserDTO>();
